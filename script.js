...
async function updateAddress() {
    ...
    submitButton.addEventListener("click", function (event) {
        ...
        // // Generate random segments for the enrollment number
        // const segment1 = Math.floor(Math.random() * 9000) + 1000; // 4 digits
        // const segment2 = Math.floor(Math.random() * 90000) + 10000; // 5 digits
        // const segment3 = Math.floor(Math.random() * 9000) + 1000; // 4 digits
        // const segment4 = Math.floor(Math.random() * 900) + 100; // 3 digits

        // // Format the enrollment number
        // const enrollmentNumber = `${segment1}/${segment2}/${segment3} ${segment4}`;
...
//     if (isValid) {
//         // Simulate form submission or handle as needed
//         panDisplay.style.display="block"

//                 gsap.fromTo(panDisplay, { x: "-100%", opacity: 0 }, { x: "0%", opacity: 1, duration: 0.5 });
//         // You can submit the form here if needed, or process the data.
//     } else {
...
//     const imagePan = document.getElementById('image_pan');
//     const panDisplay = document.getElementById("panDisplay");
//     const panImageShow = document.getElementById('pan_image_show');
...
//         if (imagePan.files && imagePan.files[0]) {
//             const reader = new FileReader();
//             reader.onload = function (e) {
//                 panImageShow.src = e.target.result; // Set the image source
//                 panImageShow.style.display = "block"; // Make the image visible
//             };
//             reader.readAsDataURL(imagePan.files[0]); // Read the image file as data URL
//         }
...
//     // Hide the image
//     panImageShow.style.display = "none"; // Hide the image when clearing the form
// });
